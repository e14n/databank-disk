...
exports.NoSuchItemError = databank.NoSuchItemError;
exports.WrongTypeError = databank.WrongTypeError;

exports.DatabankObject = databankobject.DatabankObject;

// We only want to load this if needed

exports.DriverTest = function(driver, params) {
    var DriverTest = require("./drivertest").DriverTest;
    return DriverTest(driver, params);
};